...
namespace Pokedex_oop_views.Commands
{
    public class EditTrainerCommand : AsyncCommandBase
    {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            PokedexTrainer pokedexTrainer = new PokedexTrainer(_editPokedexTrainerViewModel.PokedexTrainerId, formViewModel.NickName, formViewModel.FullName, formViewModel.Age, formViewModel.Region, formViewModel.DateOfJoining);
