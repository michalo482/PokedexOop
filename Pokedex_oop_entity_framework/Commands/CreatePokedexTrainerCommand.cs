...
{
    public class CreatePokedexTrainerCommand : ICreatePokedexTrainerCommand
    {
        private readonly PokedexTrainerDbContextFactory _contextFactory;

        public CreatePokedexTrainerCommand(PokedexTrainerDbContextFactory contextFactory)
        {
        ...
        public async Task Execute(PokedexTrainer pokedexTrainer)
        {
            using (PokedexTrainerDbContext context = _contextFactory.Create())
            {
                ...
                context.PokedexTrainers.Add(pokedexTrainerDto);
